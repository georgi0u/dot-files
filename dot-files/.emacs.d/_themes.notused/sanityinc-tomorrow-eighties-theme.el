...
(custom-theme-set-faces
 ...
 '(diff-changed ((((class color) (min-colors 89)) (:foreground "#cc99cc"))))
 '(diff-removed ((((class color) (min-colors 89)) (:foreground "#f99157"))))
 '(diff-header ((((class color) (min-colors 89)) (:foreground "#66cccc" :background nil))))
 '(diff-file-header ((((class color) (min-colors 89)) (:foreground "#6699cc" :background nil))))
 ...
 '(markdown-link-face ((((class color) (min-colors 89)) (:foreground "#6699cc" :underline t))))
 ...
 '(message-header-subject ((((class color) (min-colors 89)) (:inherit message-header-other :weight bold :foreground "#ffcc66"))))
 '(message-header-to ((((class color) (min-colors 89)) (:inherit message-header-other :weight bold :foreground "#f99157"))))
 '(message-header-cc ((((class color) (min-colors 89)) (:inherit message-header-to :foreground nil))))
 '(message-header-name ((((class color) (min-colors 89)) (:foreground "#6699cc" :background nil))))
 '(message-header-newsgroups ((((class color) (min-colors 89)) (:foreground "#66cccc" :background nil :slant normal))))
 '(message-separator ((((class color) (min-colors 89)) (:foreground "#cc99cc"))))
